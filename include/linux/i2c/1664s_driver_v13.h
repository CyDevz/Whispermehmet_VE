...
/*#######################################*/
#undef DEBUG_INFO
#undef FEATURE_DEBUG_LOW_DATA_DUMP

#define FEATURE_SUPPORT_FW_UPDATE
#ifdef FEATURE_SUPPORT_FW_UPDATE
#define FEATURE_SUPPORT_FW_UPDATE_FROM_HEADER
#undef FEATURE_SUPPORT_FW_UPDATE_OUTPUT_DEBUG
#define FEATURE_SUPPORT_FW_UPDATE_OUTPUT_CODE
#endif
#define FEATURE_SUPPORT_ZIG_TUNING

#define FEATURE_TOUCH_TOUCH_BOOSTER

#ifdef CONFIG_ENABLE_PASSIVE_PEN
#define FEATURE_TOUCH_PASSIVEPEN
#endif

#define FEATURE_TOUCH_ACTIVEPEN
#define FEATURE_TOUCH_ACTIVEPEN_TEST
...
typedef struct {
	...
	uint16_t nSRCOFFSET;
	uint8_t nLENGTH;
} __packed spt_dynamicconfigurationcontroller_t70_t;
